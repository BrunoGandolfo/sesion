...
export function Sidebar() {
  ...
  // (el sidebar vive en el layout y no se desmonta entre páginas). Solo con
  // el menú a la vista: en el teléfono este menú está montado pero oculto, y
  // pedía /api/deudores en cada navegación para un número que nadie veía.
  React.useEffect(() => {
