...
function infoCategoria(cat: Categoria): CategoriaInfo {
...
export function HotWordsManager({
  ...
  return (
    <Card className="!p-0">
      ...
      <div className="border-t border-[color:var(--border-subtle)] px-5 py-4 md:px-6">
        <Input
          id={buscarId}
          label="Buscar"
      ...
      <div className="border-t border-[color:var(--border-subtle)]">
        {loading ? (
          ...
          <div className="flex flex-col items-start gap-3 px-5 py-6 md:px-6">
          ...
          <ul className="divide-y divide-[color:var(--border-subtle)]">
            {itemsFiltrados.map((item) => {
              ...
              return (
                <li
                  key={item.id}
                  className={`flex flex-wrap items-center gap-3 px-5 py-3 md:px-6 transition-opacity duration-150 ${
      ...
      {scope === "global" && (
        <div className="flex flex-col gap-3 border-t border-[color:var(--border-subtle)] px-5 py-5 md:px-6 md:py-6">
...
function EmptyState() {
  return (
    <div className="flex flex-col items-start gap-2 px-5 py-8 md:px-6 md:py-10">
