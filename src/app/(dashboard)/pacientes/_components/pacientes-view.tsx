...
export function PacientesView({
  ...
  return (
    <div className="px-5 lg:px-10 py-6 lg:py-8 max-w-[1120px] mx-auto">
      ...
      <Fab label="Nuevo paciente" onClick={openNuevoPaciente} />
            ...
            >
              ...
              <span className="flex items-center gap-2">
                {archived ? (
                  ...
                  p.deudaTotal > 0 && (
                    <Chip variant="terracotta">{money(p.deudaTotal)}</Chip>
                  )
                )}
                <ChevronRight
                  size={16}
...
function EmptyState({
  ...
  return (
    <div className="bg-white border border-[color:var(--border-subtle)] rounded-lg px-6 py-14 flex flex-col items-center text-center">
      ...
      {kind === "noPatients" && (
        <>
          <p className="font-display italic text-[22px] text-ink-900 font-medium">
