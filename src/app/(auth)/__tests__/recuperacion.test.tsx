...
it("restablecer compara las dos contraseñas y redirige al login con aviso (el servidor cerró las sesiones)", async () => {
  ...
  expect(fetcher.mock.calls[0][0]).toBe("/api/cuenta/restablecer");
});
