...
// prueba que el dump se restaura, tiene datos y que todo lo cifrado usa
// claves conocidas, sin tener ninguna clave; el ensayo A MANO, trimestral,
// (scripts/ensayo/ensayo-manual.sh) es el que descifra una nota y una
// versión del Recorrido con el llavero del dueño, y deja un acta en
