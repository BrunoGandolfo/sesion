...
export async function presentacion(page, { alertasEsperadas = [], textosErrorEsperados = [] } = {}) {
...
// La agenda y el navegador usan el día del consultorio, también después de las 21 h.
export function fechaDePrueba(ahora = new Date()) {
  return new Intl.DateTimeFormat('en-CA', {
    timeZone:'America/Montevideo',year:'numeric',month:'2-digit',day:'2-digit',
  }).format(new Date(ahora.getTime() - 3 * 86400000));
}
