...
function cifrarFixture(columna, valor) {
  ...
  const ct = Buffer.concat([cipher.update(JSON.stringify(valor)), cipher.final()]);
...
try {
  ...
  console.log('Fixture local: nota aprobada y Para vos, persistidos y cifrados.');
